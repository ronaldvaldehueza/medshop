...
export const categoryNavigation = [
  {
    ...
    href: "/product/search/Medical Equipment",
    child: [
      {
        title: "Air or Bed Mattress",
        href: "/product/search/Mattress",
        id: 6,
        slug: "airmattress",
        icon: "Sofa",
      },
      {
        ...
        href: "/product/search/BathSafety",
        id: 3,
        slug: "bathsafety",
        icon: "BathSafety",
      },
      ...
      {
        title: "Cannes and Standing Aids",
        href: "/product/search/CannesAndAids",
        id: 2,
        slug: "cannes",
        icon: "Stool",
      },
      {
        ...
        href: "/product/search/DME",
        id: 5,
        slug: "dme",
        icon: "Wardrobe",
      },
      {
        title: "Hoist or Patient Transfer",
        href: "/product/search/Hoist",
        id: 7,
        slug: "hoist",
        icon: "Robot",
      },
      ...
      },
      {
        ...
        href: "/product/search/OrthoCare",
        id: 10,
        slug: "orthopedic",
        icon: "Shield",
      },
      {
        title: "Pediatric Mobility",
        href: "/product/search/PediaMob",
        id: 9,
        slug: "pediamob",
        icon: "BabyBoy",
      },
      {
        ...
        href: "/product/search/RespCare",
        id: 11,
        slug: "respcare",
        icon: "OxygenPump",
      },
      {
        title: "Special Needs Comfort",
        href: "/product/search/SpecNeeds",
        id: 12,
        slug: "specneeds",
        icon: "Heart",
      },
      {
        ...
        href: "/product/search/WheelchairRamp",
        id: 8,
        slug: "wheelchairramp",
        icon: "AutoMotive",
      },
  ...
  },
  {
    ...
    href: "/product/search/Medical Supplies",
    child: [
      {
        title: "PPE",
        href: "/product/search/PPE",
        id: 13,
        slug: "ppe",
        icon: "FaceMask",
      },
      {
        ...
        href: "/product/search/laboratory",
        id: 14,
        slug: "laboratory",
        icon: "Thermometer",
      },
...
export const mainCarouselData = [
  {
    ...
    buttonLink: "/",
    buttonText: "Shop",
    imgUrl: "/assets/images/Health Shop/ad-1b.png",
    title: "The least we can do is provide comfort for your disability needs. Our high-quality medical equipment does that and more—they inspire grateful smiles.",
  },
  {
    id: 2,
    buttonLink: "/",
    buttonText: "Shop",
    imgUrl: "/assets/images/Health Shop/ad-2a.png",
    title: "Service isn’t enough for us. Typical isn’t our standard. We go the extra mile—touching lives where others fall short.",
  },
  {
    id: 3,
    buttonLink: "/",
    buttonText: "Shop",
    imgUrl: "/assets/images/Health Shop/ad-3a.png",
    title: "Expertise and compassion come together in every product we offer—delivering care, comfort, and confidence when it matters most.",
  },
]; // services
